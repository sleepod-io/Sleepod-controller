...
import (
	...
	"github.com/sleepod-io/sleepod-controller/internal/controller"
	// +kubebuilder:scaffold:imports
)

var (
	scheme   = runtime.NewScheme()
	setupLog = ctrl.Log.WithName("setup").WithValues("format", "json")
)

func init() {
	utilruntime.Must(clientgoscheme.AddToScheme(scheme))

	utilruntime.Must(sleepodv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	ctrl.SetLogger(zap.New(zap.UseFlagOptions(&opts), zap.JSONEncoder(func(o *zapcore.EncoderConfig) {
		o.EncodeTime = zapcore.ISO8601TimeEncoder
	})))
