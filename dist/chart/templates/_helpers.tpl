...
*/}}
{{- define "sleepod-controller.name" -}}
...
*/}}
{{- define "sleepod-controller.fullname" -}}
...
*/}}
{{- define "sleepod-controller.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "sleepod-controller.resourceName" -}}
{{- $fullname := include "sleepod-controller.fullname" .context }}
{{- $suffix := .suffix }}
